...
/**
 * Tests for <code>RedisOutputStream</code>.
 *
...
public class RedisOutputStreamTest {
    ...
    private RedisOutputStream output = null;
    ...
    public void setUp() throws Exception {
        ...
        buffer = RedisOutputStream.class.getDeclaredField("buffer");
        buffer.setAccessible(true);

        output = new RedisOutputStream(socket, 5);
    }
    ...
    public void testWriteInsideBuffer() {
        try {
            output.write("awes".getBytes(ENCODING));
    ...
    public void testWriteOutsideBuffer() {
        ...
        try {
            output.write("awesome".getBytes(ENCODING));
    ...
    public void testWriteCrlfOutsideBuffer() {
        try {
            output.write("some".getBytes(ENCODING));
            output.writeCrlf();
    ...
    public void testFlushBuffer() {
        try {
            output.write("Hi".getBytes(ENCODING));
            output.flush();
    ...
    public void testWriteIntegerOutsideBuffer() {
        try {
            output.write("foo".getBytes(ENCODING));
            output.write(1234);
